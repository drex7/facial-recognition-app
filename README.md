...
<a href="http://localhost:5000/" target="_blank">Biometric Authentication System</a>**
...
To access the online hosted version of the project, click [here](http://localhost:5000/).
...
1. Visit the [Biometric Authentication System Website](http://localhost:5000/).
...
5. Click the "start scan now" button to initiate the face scan.
